    ...
    <div class="main">
      <div class="list">
        <div class="list-box center" v-for="(item,i) in imgList" :key="i">
          <a class="list-item am" href="javascript:;">
      ...
      imgList: [
        {
          text: "全部",
          data:
            "data:image/png;base64,"
        },
        {
          text: "视频",
          data:
